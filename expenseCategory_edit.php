...
$aaa=$_GET['id'];
$raw=$db->query("select * from expense_category where id=$aaa");
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    <h1>Expense Category Insert Form</h1>
                    <form action="expenseCategory_insert.php" method="post"> 
                <input type="hidden" value="<?php echo $infor['id'] ?>" name="id">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Category</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="category" placeholder="Enter account name" value="<?php echo $infor['category'] ?>">
                  </div>
